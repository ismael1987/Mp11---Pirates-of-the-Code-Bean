...
public class PirateService {
    ...
    public void populatePirates() {
        ...
        PirateModule piratPath = new PirateModule("classpath:pirates.csv");
        List<Pirate> pirates = csvParser.asList(piratPath);
        // for each pirate, save first manually the piece of eight,
        pirates.stream().map(pirate -> pirate.getPieceOfEight())
